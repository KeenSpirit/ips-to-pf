...
def create_new_devices(app, ids_dict_list, called_function):
    ...
    Obtain all switches in the active PowerFactory model.
...
def seq_get_setting_id(
    ...
    # Get the sub_code and the IPS switch_name.
...
def match_switch_to_relays(sub_code, switch_name, ids_dict_list):
    """
    ...
    for row in ids_dict_list:
        ...
        for char in row_sub:
            # Some relays belong to a bulk supply that uses numerics in name.
        ...
        if row["nameenu"] != switch_name:
            ...
            lookup_dict = {
                'A+CP11':['A', 'CP11'], 'A+CP12':['A', 'CP11'], 'A+CP13':['A', 'CP11'], 'A+CP14':['A', 'CP11'],
                'A+CP15':['A', 'CP11'], 'A+CP16':['A', 'CP11'], 'A+CP17':['A', 'CP11'], 'B+CP11':['B', 'CP11'],
                'B+CP12':['B', 'CP11'], 'B+CP13':['B', 'CP11'], 'B+CP14':['B', 'CP11'], 'B+CP15':['B', 'CP11'],
                'B+CP16':['B', 'CP11'], 'B+CP17':['B', 'CP11'], 'A+B+CP11':['A', 'B', 'CP11'],
                'A+B+CP12':['A', 'B', 'CP11'], 'A+B+CP13':['A', 'B', 'CP11'], 'A+B+CP14':['A', 'B', 'CP11'],
                'A+B+CP15':['A', 'B', 'CP11'], 'A+B+CP16':['A', 'B', 'CP11'], 'A+B+CP17':['A', 'B', 'CP11']
            }
            for key, value in lookup_dict.items():
                str_ln = len(key)
                if check_str[-str_ln:] == key:
                    temp_list = []
                    for var in value:
